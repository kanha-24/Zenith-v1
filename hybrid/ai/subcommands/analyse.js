...
module.exports = {
    ...
    async execute(interactionOrMessage, args = []) {
        ...
        try {
            ...
            const visionPrompt = `You are ${interactionOrMessage.client.user.username}, an AI assistant by Zenith. Analyze this image and respond to the user's request. Never mention other AI models or companies.

...
module.exports = {
    ...
    TENOR: {
        ...
        CLIENT_KEY: read('TENOR_CLIENT_KEY', 'zenith_discord_bot')
    },

    AI_PROMPTS: {
        LUNA_SYSTEM_PROMPT: read('ZENITH_SYSTEM_PROMPT', `You are Zenith, a helpful and intelligent Discord assistant.
...
- Use more detail only when the user asks for it.`),
        ...
        LUNA_CASUAL_PROMPT: read('ZENITH_CASUAL_PROMPT', `You are Zenith, a friendly assistant in a Discord chat.
